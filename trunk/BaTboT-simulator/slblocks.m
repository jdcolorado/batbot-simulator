...
blkStruct.Name = 'Motion Driver for SimMechanics';
blkStruct.OpenFcn = 'motdrv_lib';

blkStruct.Browser(1).Library = 'motdrv_lib';
blkStruct.Browser(1).Name    = 'Motion Driver for SimMechanics';